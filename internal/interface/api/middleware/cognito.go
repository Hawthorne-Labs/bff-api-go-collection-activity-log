...
// CognitoContextMiddleware validates the Authorization Bearer token and resolves email.
// It ignores browser X-Auth-* / X-User-Email headers (Python BFF contract).
